...
namespace Bingo {
	...
	public:
		...
		llong getFileSize(string fileName);
		...
		string saveFileDialog(string path, vector<string>* filterList = NULL, string title = "");
		string openFileDialog(string path, vector<string>* filterList = NULL, string title = "");
		vector<string> openFileDialogMultiple(string path, vector<string>* filterList = NULL, string title = "");
