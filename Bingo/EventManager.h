...
public:
	...
	void registerListener(EventListener* listener, EventListenType type, uint priority = 0);
	/*removes a listener from the category of that type*/
	void unregisterListener(EventListener* listener, EventListenType type);
	void cancelEvent();
private:
	//vector<EventListener*> keyListeners;
	//vector<EventListener*> mouseListeners;
	//vector<EventListener*> systemListeners;
	map<uint, vector<EventListener*>> keyListeners;
	map<uint, vector<EventListener*>> mouseListeners;
	map<uint, vector<EventListener*>> systemListeners;
