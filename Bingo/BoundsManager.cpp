...
BoundsManager::BoundsManager(){
	...
	screenEdges[0] = new BoundsLine({ 0, 0 }, { 0, windowHeight }, BLACK);
	screenEdges[1] = new BoundsLine({ 0, windowHeight }, { windowWidth, windowHeight }, BLACK);
	//screenEdges[2] = new BoundsLine({ windowWidth, windowHeight }, { windowWidth, 0 }, BLACK);
	screenEdges[2] = new BoundsLine({ windowWidth, 0 }, { windowWidth, windowHeight }, BLACK);
	//screenEdges[3] = new BoundsLine({ windowWidth, 0 }, { 0, 0 }, BLACK);
	screenEdges[3] = new BoundsLine({ 0, 0 }, { windowWidth, 0 }, BLACK);
}
...
void BoundsManager::draw(Surface& surf){
	for (uint c = 0; c < bounds.size(); c++){
