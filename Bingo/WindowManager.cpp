...
//void WindowManager::updateElement(Surface& surf){
//	SDL_Rect dest = {surf.getPosX() - 20, surf.getPosY() - 20, surf.width + 40, surf.height + 40};
//
//	SDL_UpdateWindowSurfaceRects(window, &dest, 1);
//}